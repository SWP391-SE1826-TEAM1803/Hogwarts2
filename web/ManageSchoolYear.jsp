...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="container mt-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="SchoolYearControllerURL" method="post">
                        ...
                        <div class="mb-3">
                            <label for="SyName" class="form-label">Name</label>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit School Year</h5>
                    <%
                        String error = (String) request.getAttribute("error");
                        if (error != null) {
                    %>
                    ...
                    %>
                    <form action="SchoolYearControllerURL" method="post">
                        <input type="hidden" name="service" value="updateSY">
                        <input type="hidden" name="SyID" value="<%= schoolYear.getSyID() %>">
                        <div class="mb-3">
                            <label for="SyName" class="form-label">Name</label>
                            <input type="text" class="form-control" id="SyName" name="SyName" value="<%= schoolYear.getSyName() %>" required>
                        </div>
                        <div class="mb-3">
                            <label for="DateStart" class="form-label">Start Date</label>
                            <input type="date" class="form-control" id="DateStart" name="DateStart" value="<%= schoolYear.getDateStart() %>" required>
                        </div>
                        <div class="mb-3">
                            <label for="DateEnd" class="form-label">End Date</label>
                            <input type="date" class="form-control" id="DateEnd" name="DateEnd" value="<%= schoolYear.getDateEnd() %>" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Submit</button>
                    </form>
                </div>
