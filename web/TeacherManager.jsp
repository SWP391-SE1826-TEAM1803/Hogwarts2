                            ...
                            <tbody>
                                <%
                                    ...
                                    if (vector != null) {
                                        ...
                                        String nameClass = "";
                                        if(teacherInfo.getClassName() != null){
                                         nameClass = "Active";
                                    }else{
                                        nameClass = "Inactive";
                                    }
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a class="btn btn-outline-warning btn-icon-text" href="TeacherControllerURL?service=update&TeacherID=<%= teacherInfo.getTeacherID() %>">
