...
<head>
    ...
    <title>Change Password - Hogwarts</title>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Enter your current password and new password to change it</p>
                                    </div>

                                    <form class="row g-3 needs-validation" action="UserControllerURL" method="post" novalidate>
